...
def generar_url(zona, ciudad):
    """Genera la URL de MercadoLibre para una zona y ciudad específica"""
    zona_slug = ZONAS_SLUGS[zona]

    # Buenos Aires Interior tiene una estructura diferente
    if zona == "Buenos Aires Interior":
        return f"{BASE_URL}/venta/{zona_slug}/{ciudad}/"

    return f"{BASE_URL}/{zona_slug}/{ciudad}/"
